...
The notebook [MVTec_demo.ipynb](./MVTec_demo.ipynb) provides a step-by-step guide on how to use the CFA (Coupled-hypersphere-based Feature Adaptation) and Fully Convolutional Cross-Scale-Flows methods for anomaly detection. It includes code snippets, explanations, and examples to help you understand and apply these methods to the MVTec dataset.
