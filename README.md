...
We hope this bootcamp provides a valuable learning experience in the exciting field of anomaly detection. Feel free to explore, experiment, and contribute to this repository. Make sure to read our contributing guidelines in the [CONTRIBUTING.md](CONTRIBUTING.md) file. If you have any questions or feedback, please don't hesitate to reach out.
...
### Bank Account Fraud (BAF) ([./tabular_anomaly_detection](./tabular_anomaly_detection))
...
### DGraph ([./graph_anomaly_detection](./graph_anomaly_detection))
...
### MVTec AD ([./image_anomaly_detection](./image_anomaly_detection))
...
### UCSD Pedestrian ([./video_anomaly_detection/UCSD_pedestrian](./video_anomaly_detection/UCSD_pedestrian))
...
### UCF Crime ([./video_anomaly_detection/UCF_crime](./video_anomaly_detection/UCF_crime))
