    ...
    **kwargs
    ...
    def process_graph(self, data,max_num_node):
        ...
        :param max_num_node: int
            The maximum number of nodes in the graph dataset.
        '''
        DONEBase.process_graph(data,max_num_node)
    ...
    def load_model(self, path, data):
        ...
        self.model.attr_encoder.load_state_dict(torch.load(path+'/attr_encoder.pt'))
        self.model.attr_decoder.load_state_dict(torch.load(path+'/attr_decoder.pt'))
        self.model.struct_encoder.load_state_dict(torch.load(path+'/struct_encoder.pt'))
        self.model.struct_decoder.load_state_dict(torch.load(path+'/struct_decoder.pt'))
    ...
    def save_model(self, path):
        ...
        torch.save(self.model.attr_encoder.state_dict(), path+'/attr_encoder.pt')
        torch.save(self.model.attr_decoder.state_dict(), path+'/attr_decoder.pt')
        torch.save(self.model.struct_encoder.state_dict(), path+'/struct_encoder.pt')
        torch.save(self.model.struct_decoder.state_dict(), path+'/struct_decoder.pt')
